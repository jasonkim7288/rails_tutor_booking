...
```ruby
ActiveRecord::Schema.define(version: 2020_08_05_233554) do
  ...
  create_table "attendances", force: :cascade do |t|
    ...
    t.index ["tutor_session_id"], name: "index_attendances_on_tutor_session_id"
  ...
  create_table "profiles", force: :cascade do |t|
    ...
    t.bigint "user_id", null: false
    t.string "name"
    t.integer "img_type", default: 0, null: false
  ...
  add_foreign_key "attendances", "tutor_sessions"
